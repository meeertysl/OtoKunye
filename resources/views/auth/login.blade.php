...
@section('content')
    <div class="mx-auto max-w-md">
        <section class="app-card p-6 sm:p-7">
            ...
            <h1 class="bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-2xl font-black text-transparent">Usta Girişi</h1>
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-300">Panele erişim için e-posta ve şifreni gir.</p>
            ...
            <p class="mt-4 text-center text-sm text-slate-600 dark:text-slate-300">
                Hesabın yok mu?
                <a href="{{ route('register') }}" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Usta Kaydı Oluştur</a>
            </p>
        </section>
    </div>
@endsection
